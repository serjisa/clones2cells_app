...
*How to use it?* Firstly, select a dataset and a body region of your interest. After that, you can choose which clustering resolution on clonal embedding
...
will be highlighted on a gene expression embedding on the right side. Also, you can select set of clones in selection mode (e. g. with lasso tool) and
these clones will be displayed on the right side as well.
